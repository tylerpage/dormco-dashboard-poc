                            ...
                            <form action="{{ route('orders.store') }}" method="POST">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select @error('pallet_number') is-invalid @enderror" id="pallet_number" name="pallet_number">
                                                ...
                                                @foreach($pallets as $pallet)
                                                    <option value="{{ $pallet->pallet_number }}" {{ old('pallet_number') == $pallet->pallet_number ? 'selected' : '' }}>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('notes') is-invalid @enderror" 
                                              ...
                                              placeholder="Additional notes about this order...">{{ old('notes') }}</textarea>
                                    @error('notes')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="verified" name="verified" value="1" {{ old('verified') ? 'checked' : '' }}>
