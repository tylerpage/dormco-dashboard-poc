        ...
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    ...
                    <p class="text-muted mb-0">Update school information</p>
                </div>
                <div>
                    <a href="{{ route('schools.index') }}" class="btn btn-outline-secondary">Back to Schools</a>
                    <a href="{{ route('schools.show', $school) }}" class="btn btn-outline-primary">View School</a>
                </div>
            </div>
                            ...
                            <form action="{{ route('schools.update', $school) }}" method="POST">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="email" class="form-control @error('contact_email') is-invalid @enderror" 
                                                   id="contact_email" name="contact_email" value="{{ old('contact_email', $school->contact_email) }}">
                                            @error('contact_email')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control @error('contact_phone') is-invalid @enderror" 
                                                   id="contact_phone" name="contact_phone" value="{{ old('contact_phone', $school->contact_phone) }}">
                                            @error('contact_phone')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('notes') is-invalid @enderror" 
                                              ...
                                              placeholder="Additional notes about this school...">{{ old('notes', $school->notes) }}</textarea>
                                    @error('notes')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="d-flex gap-2">
                                    ...
                                    <a href="{{ route('schools.show', $school) }}" class="btn btn-outline-secondary">Cancel</a>
                                </div>
                            </form>
                        </div>
                    </div>
