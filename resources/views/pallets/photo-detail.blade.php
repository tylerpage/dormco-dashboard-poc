            ...
            <div class="row mb-4">
                <div class="col-12">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            @if($currentIndex > 0)
                                <a href="{{ route('pallets.photos.show', [$pallet, $photos[$currentIndex - 1]]) }}" 
